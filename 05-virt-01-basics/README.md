...
- Если бы у вас был выбор, то создавали бы вы гетерогенную среду или нет
    * Если бы у меня был выбор, я бы не создавал гетерогенную среду, так как обслуживание единой инфраструры гораздо проще и дешевле. За исключением ситуаций, когда например 80% инфрастуктуры на Windows, остальная часть серверов под управлением Linux (при этом не планируется, что процентное соотношение сильно изменится в будущем) и бизнес не может выделить дополнительные средства на развитие, тогда конечно же проще одновременно использовать Hyper-V и например KVM для Linux.
