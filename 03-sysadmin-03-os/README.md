...
4. Занимают ли зомби-процессы какие-то ресурсы в ОС (CPU, RAM, IO)?
    ...
    * Если же процесс **сирота** (процесс родитель завершился раньше, по какой либо причине) - ресурсы будут расходоваться до тех пор, пока процесс init с PID=1 не выполнит wait() для процесса **"сироты"**
